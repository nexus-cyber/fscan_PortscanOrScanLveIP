...
func Flag(Info *HostInfo) {
	...
	flag.Int64Var(&PortconnectTimeout, "porttime", 3000, "Set portscan connect timeout (default 3000ms)")
	flag.Int64Var(&Porttry, "pt", 0, "Set port connect error retry num (default 0)")
	flag.StringVar(&Scantype, "m", "all", "Select scan type ,as: -m ssh or -m ops(only port scan)")
